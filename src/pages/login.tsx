...
export default function LoginPage() {
  ...
  const onSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // Router redirect handled by useEffect above
    } catch (e2: any) {
        ...
        <div className="bg-white border border-slate-100 rounded-3xl shadow-lg overflow-hidden">
          <div className="px-6 py-8 sm:px-10 sm:py-10 flex flex-col justify-center">
            ...
            <form onSubmit={onSubmit} className="mt-8 space-y-4">
              ...
              <button
                disabled={loading}
                className="w-full rounded-xl bg-[#0062FF] hover:bg-[#0051d6] text-white font-semibold py-3 disabled:opacity-60 shadow-md transition-all"
              >
